...
export function ModelLaunch({ modelFile, configName = 'default', onBack }: ModelLaunchProps) {
    ...
    <Box flexDirection="row" gap={2} height="100%">
      ...
      >
        ...
        <Box flexDirection="column" marginTop={1} gap={0}>
          <InfoRow label="Model"   value={server.modelFile?.replace(/\.gguf$/, '') ?? '—'} />
          ...
          {stats ? (
            <>
              <InfoRow
                ...
                color={stats.cpuPercent > 80 ? 'red' : stats.cpuPercent > 50 ? 'yellow' : 'green'}
              />
